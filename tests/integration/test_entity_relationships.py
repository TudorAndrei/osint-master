class TestEntityRelationshipIntegration:
    def test_person_domain_relationship_flow(self, client) -> None:
    ...
    def test_multiple_relationships_for_entity(self, client) -> None:
        person_response = client.post(
            "/api/v1/persons",
    ...
    def test_finding_with_related_entities(self, client) -> None:
        person_response = client.post(
            "/api/v1/persons",
    ...
    def test_organization_person_relationship(self, client) -> None:
