...
from app.models import Person, Domain, IPAddress, Relationship


class TestEntityOperations:
    def test_create_and_retrieve_person(self, test_db):
        person = Person(
            name="Test Person",
            aliases=["TP"],
            nationality="US"
    ...
    def test_list_entities(self, test_db):
    ...
    def test_update_entity(self, test_db):
    ...
    def test_delete_entity(self, test_db):
    ...
    def test_get_nonexistent_entity(self, test_db):
        result = get_entity(test_db, "Person", "nonexistent-id")
        assert result is None


class TestDomainOperations:
    def test_create_domain(self, test_db):
    ...
    def test_domain_normalization_stored(self, test_db):
        domain = Domain(domain_name="EXAMPLE.COM")
        entity_id = create_entity(test_db, "Domain", domain)
...
class TestIPAddressOperations:
    def test_create_ipv4(self, test_db):
    ...
    def test_create_ipv6(self, test_db):
...
class TestRelationshipOperations:
    ...
    def test_get_relationships(self, test_db):
    ...
    def test_relationship_bidirectional_query(self, test_db):
