class TestPersonEndpoints:
    def test_create_person(self, client) -> None:
    ...
    def test_get_person(self, client) -> None:
    ...
    def test_get_nonexistent_person(self, client) -> None:
        response = client.get("/api/v1/persons/nonexistent-id")
        assert response.status_code == 404

    def test_list_persons(self, client) -> None:
    ...
    def test_update_person(self, client) -> None:
        create_response = client.post(
            "/api/v1/persons",
    ...
    def test_delete_person(self, client) -> None:
        create_response = client.post(
            "/api/v1/persons",
            json={"name": "To Delete"},
        )
...
class TestDomainEndpoints:
    def test_create_domain(self, client) -> None:
        response = client.post(
            "/api/v1/domains",
    ...
    def test_domain_validation(self, client) -> None:
        response = client.post(
            "/api/v1/domains",
            json={"domain_name": ""},
        )
...
class TestIPAddressEndpoints:
    def test_create_ipv4(self, client) -> None:
        response = client.post(
            "/api/v1/ip-addresses",
    ...
    def test_invalid_ip_rejected(self, client) -> None:
        response = client.post(
            "/api/v1/ip-addresses",
...
class TestOrganizationEndpoints:
    def test_create_organization(self, client) -> None:
        response = client.post(
...
class TestEmailAddressEndpoints:
    def test_create_email(self, client) -> None:
        response = client.post(
...
class TestSocialMediaProfileEndpoints:
    def test_create_profile(self, client) -> None:
        response = client.post(
...
class TestFindingEndpoints:
    def test_create_finding(self, client) -> None:
        response = client.post(
            "/api/v1/findings",
            json={
                "title": "Test Finding",
...
class TestRelationshipEndpoints:
    def test_create_relationship(self, client) -> None:
    ...
    def test_get_relationships(self, client) -> None:
        person_response = client.post(
            "/api/v1/persons",
    ...
    def test_self_referential_relationship_rejected(self, client) -> None:
        person_response = client.post(
            "/api/v1/persons",
