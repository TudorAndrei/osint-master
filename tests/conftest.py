...
from app.db.connection import get_db, close_db, settings
...
def setup_test_db(test_db_settings, monkeypatch):
    ...
    monkeypatch.setenv("FALKORDB_PASSWORD", str(test_db_settings["falkordb_password"] or ""))
    ...
    monkeypatch.setattr(settings, "falkordb_password", test_db_settings["falkordb_password"])
